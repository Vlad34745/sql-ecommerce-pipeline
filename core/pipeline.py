...
from core.loaders import load_to_sqlite, load_to_postgres
from core.postgres_manager import init_postgres_db
from core.quality import validate_records, print_quality_report

def run_pipeline(users=None, orders=None, seed=None, reset=False, skip_postgres=False):
    users = users or settings.users
    orders = orders or settings.orders
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reset", action="store_true", help="Drop and recreate both databases before loading")
